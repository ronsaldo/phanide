...
msbuild Phanide.sln /p:Configuration=Debug /p:Platform=%VS_PLATFORM%
msbuild Phanide.sln /p:Configuration=RelWithDebInfo /p:Platform=%VS_PLATFORM%
msbuild Phanide.sln /p:Configuration=Release /p:Platform=%VS_PLATFORM%
