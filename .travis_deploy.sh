...
if test "$BINTRAY_APIKEY" != ""; then
    ...
    curl -T "$ARCHIVE_NAME" -uronsaldo:$BINTRAY_APIKEY "https://api.bintray.com/content/ronsaldo/phanide/lib/${VERSION_NAME}/${ARCHIVE_NAME}?publish=1"
    echo
fi
